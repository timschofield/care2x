...
<!--  The  row for batch number -->
	...
	<tr>
	 ...
	 <tr>
        <td> 
         <font size=2 color="purple" face="verdana,arial"><?php if ($h_encounter_class_nr == "2") { echo 'Clinic/Department :'; echo $h_opd_admission; } else {  echo 'Ward/Station :'; echo $h_ipd_admission; } ?> </font>
