...
$LDClinicalSum='Clinical Summary:';
$LDNames='Names';
$LDDoctorRequest='Requested by: ';
$LDReportingRad='Reporting Radiologist';
$LDRadiologyDiagnostics='RADIOLOGY DIAGNOSTICS REQUEST';

$LDRequestDate='Request Date: ';
$LDNoOfTests='Number Of Tests:';
$LDPlsEnterNoOfTests='Please enter number of tests !';
$LDPlsEnterClinicalInfo='Please enter clinical information !';

$LDRadRequestNotBilled='Radiology request not billed!';
$LDRadRequestBilled='Radiology request billed. Bill. No:';
