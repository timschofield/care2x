  ...
  */
  function class_selianreport() {
    ...
    function DisplayBillingTableHead(){
    	global $PRINTOUT;
    	global $LDDailyFinancialRecordOPD,$LDDate,$LDAdvance,$LDAmb,$LDBed,$LDConsult,$LDConsum,$LDDental,$LDDrugs,$LDFile,$LDICU,$LDLab,$LDMort,$LDMinProc,$LDProcSurg,
$LDImaging,$LDWChair,$LDTotal;
		...
		$table_head = "<tr>\n";
		if (!$PRINTOUT)
			$table_head .= "<td bgcolor=\"#ffffaa\" colspan=\"17\" align=\"center\">".$LDDailyFinancialRecordOPD."</td>\n";
		else
			$table_head .= "<td colspan=\"17\" align=\"center\">".$LDDailyFinancialRecordOPD."</td>\n";
		$table_head.="</tr>\n";
...
$LDImaging,$LDWChair,$LDTotal;
		...
		$table_head = "<tr>\n";
		if (!$PRINTOUT)
			$table_head .= "<td bgcolor=\"#ffffaa\" colspan=\"17\" align=\"center\">Cash Financial Summary : $admissionclass </td>\n";
		else
			$table_head .= "<td colspan=\"17\" align=\"center\">Cash  Financial Summary : $admissionclass </td>\n";
		$table_head.="</tr>\n";
...
function DisplayCashReceiptsTableHead($admission){
    	global $PRINTOUT;
    	global $LDDailyFinancialRecordOPD,$LDDate,$LDBillNo,$LDAdvance,$LDAmb,$LDBed,$LDConsult,$LDConsum,$LDDental,$LDDrugs,$LDFile,$LDICU,$LDLab,$LDMort,$LDMinProc,$LDProcSurg,
$LDImaging,$LDWChair,$LDTotal;
		...
		$table_head = "<tr>\n";
		if (!$PRINTOUT)
			$table_head .= "<td bgcolor=\"#ffffaa\" colspan=\"18\" align=\"center\"> $admissionclass Cash Receipts Summary </td>\n";
		else
			$table_head .= "<td colspan=\"18\" align=\"center\"> $admissionclass Cash  Receipts Summary</td>\n";
		$table_head.="</tr>\n";
...
function DisplayInsuranceBillingTableHead($admission){
    	...
    	global $LDDailyFinancialRecordOPD,$LDDate,$LDAmb,$LDAdvance,$LDBed,$LDConsult,$LDConsum,
    	       $LDDental,$LDDrugs,$LDFile,$LDICU,$LDLab,$LDMort, $LDMinProc,$LDProcSurg,$LDImaging,$LDWChair,$LDTotal;
		...
		$table_head = "<tr>\n";
		if (!$PRINTOUT)
			$table_head .= "<td bgcolor=\"#ffffaa\" colspan=\"17\" align=\"center\">Insurance Financial Summary : $admissionclass </td>\n";
		else
			$table_head .= "<td colspan=\"17\" align=\"center\">Insurance  Financial Summary : $admissionclass </td>\n";
		$table_head.="</tr>\n";
...
function DisplayInsuranceCompanyBillingTableHead($insurance_id,$admission){
	global $db;
        global $PRINTOUT;
        global $LDDailyFinancialRecordOPD,$LDDate,$LDPatient,$LDAdvance,$LDAmb,$LDBed,$LDConsult,$LDConsum,$LDDental,$LDDrugs,$LDFile,$LDICU,
               $LDLab,$LDMort,$LDMinProc,$LDProcSurg,$LDImaging,$LDWChair,$LDTotal;
		...
		$insurancename = $sql_insurancename['name'];
                ...
                $table_head = "<tr>\n";
                if (!$PRINTOUT)
                        $table_head .= "<td bgcolor=\"#ffffaa\" colspan=\"18\" align=\"center\"> $admissionclass Financial Summary for $insurancename </td>\n";
                else
                        $table_head .= "<td colspan=\"18\" align=\"center\"> $admissionclass Financial Summary for $insurancename </td>\n";
                $table_head.="</tr>\n";
...
function DisplayPendingQuotationsTableHead($admission,$pricelist) {
	    global $db;
        global $PRINTOUT;
        global $LDPendingQuotationsReport,$LDDate,$LDAmb,$LDBed,$LDConsult,$LDConsum,$LDDental, $LDDrugs,$LDFile,$LDICU,
               $LDLab,$LDMort,$LDMinProc,$LDProcSurg,$LDImaging,$LDWChair,$LDTotal;
		...
		$table_head = "<tr>\n";
                if (!$PRINTOUT) 
		$table_head .= "<td bgcolor=\"#ffffaa\" colspan=\"17\" align=\"center\">  $admissionclass Pending Quotations Report assuming $price_detail pricelist</td>\n";
                else
                        $table_head .= "<td colspan=\"17\" align=\"center\"> $admissionclass Pending Quotations Report assuming $price_detail pricelist </td>\n";
                $table_head.="</tr>\n";
...
/**
	...
	function _get_amount_of($start_timeframe,$day,$filter,$total_summary) {
		...
		global $db;
		global $LDAmb,$LDBed,$LDConsult,$LDConsum,$LDDental,$LDDrugs,$LDFile,$LDICU,$LDLab,$LDMort,$LDMinProc,$LDProcSurg,$LDRadio,$LDWChair,$LDTotal;
		...
		switch ($filter) {
			...
			case "proc/surg":
				...
				$sql_filter="WHERE ( purchasing_class='eye-service' OR purchasing_class='obgyne_op' OR purchasing_class='ortho_op' OR purchasing_class='surgical_op') AND $curr_day_start <=date_change AND $curr_day_end>=date_change ";
				break;
...
AND from_unixtime($curr_day_start,'%d-%m-%Y') <= from_unixtime(date_change,'%d-%m-%Y') AND from_unixtime($curr_day_end,'%d-%m-%Y') >= from_unixtime(date_change,'%d-%m-%Y')  $and_bill";
			...
			case "wchair"://returns
				if ($debug) echo "wchair<br>";
   				$sql_filter="WHERE purchasing_class='service' AND item_number like 'W%' AND from_unixtime($curr_day_start,'%d-%m-%Y') <= from_unixtime(date_change,'%d-%m-%Y') AND from_unixtime($curr_day_end,'%d-%m-%Y') >= from_unixtime(date_change,'%d-%m-%Y')  $and_bill";
				break;
...
function _get_prepaid_amount_of($start_timeframe,$day,$insuranceid,$filter,$total_summary) {
		...
		$sql_filter="WHERE (  purchasing_class='drug_list') AND from_unixtime($curr_day_start,'%d-%m-%Y') <= from_unixtime(date_change,'%d-%m-%Y') AND from_unixtime($curr_day_start,'%d-%m-%Y') >= from_unixtime(date_change,'%d-%m-%Y') AND  insurance_id='$insuranceid'";
			...
			case "proc/surg		
				if ($debug) echo $LDProcSurg<br>";
				$sql_filter="WHERE ( purchasing_class='eye-service'  OR purchasing_class='obgyne_op' OR purchasing_class='ortho_op' OR purchasing_class='surgical_op') AND from_unixtime($curr_day_start,'%d-%m-%Y') <= from_unixtime(date_change,'%d-%m-%Y') AND from_unixtime($curr_day_start,'%d-%m-%Y') >= from_unixtime(date_change,'%d-%m-%Y') AND  insurance_id='$insuranceid'";
				break;
...
function _get_insurance_company_amount_of($start_timeframe,$day,$encounternr,$insuranceid,$filter,$total_summary) {
		...
		global $db;
		global $LDAdvance,$LDAmb,$LDBed,$LDConsult,$LDConsum,$LDDental,$LDDrugs,$LDFile,$LDICU,$LDLab,$LDMort,$LDMinProc,$LDProcSurg,$LDRadio,$LDWChair,$LDTotal;
...
$admission_encounter $and_bill";
	...
	function _get_pending_amount_of($start_timeframe,$day,$filter,$pricelist,$total_summary) {
		...
		global $db;
		global$LDAmb,$LDBed,$LDConsult,$LDConsum,$LDDental,$LDDrugs,$LDFile,$LDICU,$LDLab,
$LDMort,$LDMinProc,$LDProcSurg,$LDImaging,$LDWChair,$LDTotal;
...
"proc/surg", TRUE).$italic_tag_close."</td>\n";
		...
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_cash_amount_of($start_timeframe,1,"wchair", TRUE).$italic_tag_close."</td>\n";
...
function DisplayCashReceiptsTestSummary($start_timeframe, $end_timeframe, $admission){
		...
		$sql_encounter_nr="SELECT distinct(BillNumber) FROM tmp_billing_master where  from_unixtime( date_change, '%Y-%d-%m' )=from_unixtime( $current_day, '%Y-%d-%m' )  ";
			...
			*/
                ...
                $table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,$day,$billnr,"wchair", FALSE).$italic_tag_close."</td>\n";
		...
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_advance_amount_of($start_timeframe,$admission,1,$billnr,"", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,$billnr,"amb", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,$billnr,"bed", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,$billnr,"consult", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,$billnr,"consum", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,$billnr,"dental", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,$billnr,"drugs", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,$billnr,"file", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,$billnr,"icu", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,$billnr,"lab", TRUE).$italic_tag_close."</td>\n";
                $table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,$billnr,"mort", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,$billnr,"minproc", TRUE).$italic_tag_close."</td>\n";
        $table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,$billnr,"proc/surg", TRUE).$italic_tag_close."</td>\n";
        $table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,$billnr,"radio", TRUE).$italic_tag_close."</td>\n";
        $table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,$billnr,"wchair", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,$billnr,"total", TRUE).$italic_tag_close."</td>\n";
...
function DisplayInsuranceBillingTestSummary($start_timeframe, $end_timeframe, $admission){
		...
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_amount_of($start_timeframe,1,"minproc", TRUE).$italic_tag_close."</td>\n";
                ...
                $table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_amount_of($start_timeframe,1,"wchair", TRUE).$italic_tag_close."</td>\n";
...
function DisplayInsuranceCompanyTestSummary($start_timeframe, $end_timeframe, $insuranceid, $admission){
	...
	$sql_encounter_nr="SELECT distinct (encounter_nr)  as encounternr , pid FROM tmp_billing_master where insurance_id='$insuranceid' and from_unixtime( date_change, '%Y-%d-%m' )=from_unixtime( $current_day, '%Y-%d-%m' )  ";
		...
		if (!$PRINTOUT)$bg_color="#CC9933";
				...
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_company_amount_of($start_timeframe,1,$insuranceid,"amb", TRUE).$italic_tag_close."</td>\n";
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_company_amount_of($start_timeframe,1,$insuranceid,"bed", TRUE).$italic_tag_close."</td>\n";
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_company_amount_of($start_timeframe,1,$insuranceid,"consult", TRUE).$italic_tag_close."</td>\n";
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_company_amount_of($start_timeframe,1,$insuranceid,"consum", TRUE).$italic_tag_close."</td>\n";
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_company_amount_of($start_timeframe,1,$insuranceid,"dental", TRUE).$italic_tag_close."</td>\n";
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_company_amount_of($start_timeframe,1,$insuranceid,"drugs", TRUE).$italic_tag_close."</td>\n";
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_company_amount_of($start_timeframe,1,$insuranceid,"file", TRUE).$italic_tag_close."</td>\n";
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_company_amount_of($start_timeframe,1,$insuranceid,"icu", TRUE).$italic_tag_close."</td>\n";
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_company_amount_of($start_timeframe,1,$insuranceid,"lab", TRUE).$italic_tag_close."</td>\n";
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_company_amount_of($start_timeframe,1,$insuranceid,"mort", TRUE).$italic_tag_close."</td>\n";
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_company_amount_of($start_timeframe,1,$insuranceid,"minproc", TRUE).$italic_tag_close."</td>\n";
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_company_amount_of($start_timeframe,1,$insuranceid,"proc/surg", TRUE).$italic_tag_close."</td>\n";
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_company_amount_of($start_timeframe,1,$insuranceid,"radio", TRUE).$italic_tag_close."</td>\n";
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_company_amount_of($start_timeframe,1,$insuranceid,"wchair", TRUE).$italic_tag_close."</td>\n";
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_company_amount_of($start_timeframe,1,$insuranceid,"total", TRUE).$italic_tag_close."</td>\n";
...
$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.date("j/m/Y",$this->_get_requested_day($start_timeframe, $day-1, FALSE)).$italic_tag_close."</td>\n";
				...
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_pending_amount_of($start_timeframe,$day,"wchair", $pricelist,FALSE).$italic_tag_close."</td>\n";
		...
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_pending_amount_of($start_timeframe,1,"wchair", $pricelist,TRUE).$italic_tag_close."</td>\n";
