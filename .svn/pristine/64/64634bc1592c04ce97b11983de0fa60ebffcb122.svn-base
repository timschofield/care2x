...
function increaseUnitHit($nr,$count='1'){
	...
	*/
	...
	/* Returns all Temperature units.
	*
	* @access public
	* @return mixed 2 dimensional array or boolean
	*/
	function temperatureUnits(){
		return $this->_getUnits('unit_type_nr=5');
	}
	/* Returns all blood presssure.
	*
	* @access public
	* @return mixed 2 dimensional array or boolean
	*/
	function pressureUnits(){
		return $this->_getUnits('unit_type_nr=4');
	}

	/**
	* Returns all Per minute units.
	*
	* @access public
	* @return mixed 2 dimensional array or boolean
	*/
	function rateUnits(){
		return $this->_getUnits('unit_type_nr=7');
	}
}
?>
