...
$sql_tmp_dept = "CREATE  TEMPORARY TABLE tmp_table3 TYPE=HEAP (SELECT nr,type,name_formal,name_short,admit_outpatient,is_inactive,status FROM care_department
...
$sql_tmp_enc = "CREATE TEMPORARY TABLE tmp_table TYPE=HEAP (SELECT encounter_nr,encounter_date,current_dept_nr FROM care_encounter 
