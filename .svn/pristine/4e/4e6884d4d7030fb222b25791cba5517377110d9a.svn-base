...
<b>Bacteriological laboratory test request</b></font>
<p>
...
<ul> 
	<b>Step: </b>Click the small pink rectangle below the parameter to "blacken" it.<p>
...
<ul> 
	<b>Step: </b>Click again the small "blackened" rectangle below the parameter to "unblacken" it.<br>
</ul>
