...
<?php $insurance_tz->Display_Headline($LDInsuranceMenu, 'insurance_menu.php','Insurance Management :: Main Menu'); ?>
...
<?php $insurance_tz->Display_Footer($LDInsuranceMenu, 'insurance_menu.php','Insurance Management :: Main Menu'); ?>
