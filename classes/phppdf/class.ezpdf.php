<?php
# Added 2003-11-30 by Elpidio Latorilla for care2x
if(file_exists($classpath.'class.pdf.php')) include_once($classpath.'class.pdf.php');
 elseif(file_exists('class.pdf.php')) include_once('class.pdf.php');# Modified by 2003-11-30 by Elpidio Latorilla for care2x
