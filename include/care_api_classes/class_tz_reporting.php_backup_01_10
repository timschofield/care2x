...
$LDImaging,$LDWChair,$LDTotal;
		...
		$table_head = "<tr>\n";
		if (!$PRINTOUT)
			$table_head .= "<td bgcolor=\"#ffffaa\" colspan=\"17\" align=\"center\">Cash Financial Summary</td>\n";
		else
			$table_head .= "<td colspan=\"17\" align=\"center\">Cash  Financial Summary</td>\n";
		$table_head.="</tr>\n";
...
function DisplayInsuranceBillingTableHead(){
		...
		$table_head = "<tr>\n";
		if (!$PRINTOUT)
			$table_head .= "<td bgcolor=\"#ffffaa\" colspan=\"17\" align=\"center\">Insurance Financial Summary</td>\n";
		else
			$table_head .= "<td colspan=\"17\" align=\"center\">Insurance  Financial Summary</td>\n";
		$table_head.="</tr>\n";
...
function DisplayInsuranceCompanyBillingTableHead($insurance_id){
	global $db;
		...
		$insurancename = $sql_insurancename['name'];
                ...
                $table_head = "<tr>\n";
                if (!$PRINTOUT)
                        $table_head .= "<td bgcolor=\"#ffffaa\" colspan=\"18\" align=\"center\"> Financial Summary for $insurancename </td>\n";
                else
                        $table_head .= "<td colspan=\"18\" align=\"center\">Financial Summary for $insurancename </td>\n";
                $table_head.="</tr>\n";
...
function DisplayPendingQuotationsTableHead($admission,$pricelist) {
		...
		$bill_obj = New Bill;
		$price_detail = $bill_obj->GetMeaningOfPrices($pricelist);
		...
		$table_head = "<tr>\n";
                if (!$PRINTOUT)
		$table_head .= "<td bgcolor=\"#ffffaa\" colspan=\"17\" align=\"center\"> Pending $admissionclass Quotations Report assuming $price_detail pricelist</td>\n";
                else
                        $table_head .= "<td colspan=\"17\" align=\"center\">Pending $admissionclass Quotations Report assuming $price_detail pricelist </td>\n";
                $table_head.="</tr>\n";
...
function DisplayDeletedQuotationsTableHead($pricelist) {
	...
	$bill_obj =New Bill;
	$price_details = $bill_obj->GetMeaningOfPrices($pricelist);
...
$italic_tag_close."</td>\n";
				...
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$amount.$italic_tag_close."</td>\n";
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$del_row['disable_id'].$italic_tag_close."</td>\n";
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$del_row['disable_date'].$italic_tag_close."</td>\n";
...
$table.="</tr>\n";
	...
	function DisplayDeletedQuotationsTestRows() {
	...
	function DisplayPharmacyTableHead($admission){
		global $PRINTOUT;
	...
	function DisplayPharmacyResultRows($start_timeframe, $end_timeframe, $admission){
		global $db;
		global $PRINTOUT;
