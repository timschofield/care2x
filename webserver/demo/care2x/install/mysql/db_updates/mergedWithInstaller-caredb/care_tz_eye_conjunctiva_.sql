...
-- 
-- Host: localhost
-- Generation Time: Apr 10, 2008 at 10:07 AM
...
INSERT INTO `care_tz_eye_conjunctiva` VALUES (1, 10022423, 'on', 'on', 'on', 'on', 'on', 'on', 'on', 'on', 'on', 'on', 'on', 'on', 'on', 'on', 'on', 'on', 'co', '2008-03-28');
