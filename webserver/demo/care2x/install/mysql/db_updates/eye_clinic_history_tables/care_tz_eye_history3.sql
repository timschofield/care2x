...
-- 
-- Host: localhost
-- Generation Time: Oct 03, 2008 at 10:18 AM
...
-- 
-- Table structure for table `care_tz_eye_history3`
-- 
...
CREATE TABLE `care_tz_eye_history3` (
  ...
  `hid6` varchar(100) collate latin1_general_ci NOT NULL default '',
...
-- 
-- Dumping data for table `care_tz_eye_history3`
-- 
