...
-- 
-- Host: localhost
-- Generation Time: Oct 03, 2008 at 10:17 AM
...
-- 
-- Table structure for table `care_tz_eye_history2`
-- 
...
CREATE TABLE `care_tz_eye_history2` (
  ...
  `hid7e` varchar(100) collate latin1_general_ci NOT NULL,
  `hid7d` varchar(100) collate latin1_general_ci NOT NULL,
  `hid8` varchar(100) collate latin1_general_ci NOT NULL,
...
-- 
-- Dumping data for table `care_tz_eye_history2`
-- 
