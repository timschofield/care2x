...
*/  
	...
	if($ttf_ok){
    	ImageTTFText($im,12,0,$lmargin,$tmargin+10,$black,$arial,ar2uni($LDPrintPortraitFormat));
    	ImageTTFText($im,12,0,$lmargin,$tmargin+25,$black,$arial,ar2uni($LDClickImgToPrint));
	}else{
