...
$LDRadData = 'Radiology - Display data';
$LDRadEditData = 'Radiology - Edit data';

$LDRadReport='Radiology Report';
$LDEditRadReport='Edit/Change Report';
$LDPatientResults='Display Diagnostic Results';
$LDPatientResultsTxt='Search and display patient diagnostic results';

$LDEditResults='Edit Results';
$LDEditResultsTxt='Search and edit patient diagnostic results';
