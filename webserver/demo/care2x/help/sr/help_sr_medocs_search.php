...
<b>Medocs - Finding the patient</b></font>
<p>
...
<ul> 
	...
	<b>Step 1: </b>If the patient is in the resulting list, click its <img <?php echo createComIcon('../','statbel2.gif','0') ?>> icon to display its
