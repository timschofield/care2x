...
<b>Requisição de teste de laboratorio</b></font>
<p>
...
<ul> 
	<b>Passo: </b>Clique no pequeno retângulo rosa ao lado do parâmetro para "escurecê-lo".<p>
...
<ul> 
	<b>Passo: </b>Clique novamente no pequeno retângulo "escurecido" ao lado do parâmetro para voltar à cor anterior.<br>
</ul>

<a name="sday"><img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b></a>
Como marcar o dia da amostragem?</b></font>
<ul> 
	<b>Passo: </b>Clique no pequeno retângulo rosa abaixo do dia para "escurecê-lo".<p>
...
<ul> 
	<b>Passo: </b>Clique no pequeno retângulo rosa abaixo do tempo em horas e minutos para "escurecê-lo".<p>
