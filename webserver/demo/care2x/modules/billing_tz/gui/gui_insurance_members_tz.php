...
<script language="javascript" src="../../js/check_insurance_form.js"></script>
			...
			<form name="insurance" method="post" action="insurance_members_tz.php<?php echo URL_APPEND; ?>&pid=<?php echo $pid; ?>">
			<input type="hidden" name="mode" value="update">
			<table width="100%" height="100%" border="0" cellpadding="1" cellspacing="1">
				<tr>
					<td width="100%" align="center">
						<?php if (!$_SESSION['company_id']) {
						echo $LDSelectInsurance.'<br>';
						$insurance_tz->ShowInsurancesDropDown('company_id',$company_id);
						}
						else $company_id = $_SESSION['company_id'];?>
						...
						<table  bgcolor="grey">
							...
							<select name="itemlist[]" size="5" style="width:435px;" onDblClick="javascript:item_add();">
							...
							<tr>
								<td><div align="center" bgcolor="grey">
						<select name="selected_item_list[]" size="5" style="width:435px;" onDblClick="javascript:item_delete();">
							<!-- dynamically managed content -->
