...
<tr>
		                    ...
		                    <?php echo '<a href="'.$root_path.'modules/billing_tz/billing_tz_advance.php'.URL_APPEND.'&batch_nr='.$pid.'&encounter_nr='.$_REQUEST['encounter_nr'].'&patient='.$patient.'">'; 
							
						echo '<input type="button" value ="'.$LDProcessAdvance.'">';  echo'</a>'; ?> 
