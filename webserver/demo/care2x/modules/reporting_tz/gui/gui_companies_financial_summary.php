...
$rep_obj->DisplayCompaniesBillingTableHead($admission);
$rep_obj->DisplayCompaniesTestSummary($start_timeframe, $end_timeframe, $admission);
$rep_obj->DisplayCompaniesBillingResultRows($start_timeframe, $end_timeframe, $admission);
echo '</table>';
echo '</html></body>';
exit();
}
...
function gethelp(x,s,x1,x2,x3,x4)
{
    ...
    function printOut(start_timeframe, end_timeframe, admission)
    {
    	urlholder="./companies_financial_summary.php?printout=TRUE&start_timeframe="+start_timeframe+"&end_timeframe="+end_timeframe+"&admission="+admission;
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo 'Companies Revenue Summary'; ?></font></td>
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<form name="form1" method="post" action="">
                          ...
                          <?php $rep_obj->DisplayCompaniesBillingTableHead($admission);?>

						  <?php $rep_obj->DisplayCompaniesBillingTestSummary($start_timeframe, $end_timeframe, $admission);?>
