...
$rep_obj->DisplayTBBillingTableHead();
$rep_obj->DisplayTBBillingTestSummary($start_timeframe, $end_timeframe);
$rep_obj->DisplayTBBillingResultRows($start_timeframe, $end_timeframe);
echo '</table>';
echo '</html></body>';
exit();
}
...
function gethelp(x,s,x1,x2,x3,x4)
{
    ...
    {
    	urlholder="./tb_billing_summary.php?printout=TRUE&start_timeframe="+start_timeframe+"&end_timeframe="+end_timeframe;
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo 'Reporting:Daily Financial Record(TB)'; ?></font></td>
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<form name="form1" method="post" action="">
                          ...
                          <?php $rep_obj->DisplayTBBillingTableHead();?>

						  <?php $rep_obj->DisplayTBBillingTestSummary($start_timeframe, $end_timeframe);?>
						  <?php $rep_obj->DisplayTBBillingResultRows($start_timeframe, $end_timeframe);?>
                          </table>
				</form>
