...
if(isset($mode)&&$mode=='save'){
	...
	if ($_POST['expire']!=''){
		$cd_obj->_save_Password_Expiring($_POST['expire']);
	}
...
$expire = (int)$cd_obj->__read_Password_Expiring();;
...
<tr valign=top>
	<td  class="wardlisttitlerow"  align="right">
	<FONT  color="#0000cc"><b><nobr><?php echo $LDTimeExpire ?></nobr></b> </FONT></td>
	<td class="wardlistrow1"><nobr>
        <select name="expire" id="expire" style="width:100px;">
          <option <?php echo ($expire==60)?'selected="selected"':'' ?> value="60">60 Days</option>
          <option <?php echo ($expire==75)?'selected="selected"':'' ?> value="75">75 Days</option>
          <option <?php echo ($expire==90)?'selected="selected"':'' ?> value="90">90 Days</option>
          <option <?php echo ($expire==0)?'selected="selected"':'' ?> value="0" >Never  </option>
        </select>
	</td>
	<td class="wardlistrow2"><?php echo $LDTimeExpireTxt ?></td>
</tr>
<?php } ?>
