		...
		if(prepareTestElements())
		{
			...
			if($diag_obj->insertDataFromInternalArray()){
				...
				foreach( $singleParam as $key => $value) {
					...
					$diag_obj_sub->setRefArray($parsedParamList);
...
/*
					...
					$item_id = $pres_obj->GetItemIDByNumber('LAB'.$pre_item_id);
						...
						<!--<td>&nbsp;oo</td>-->
							<td>
									<table cellpadding="0" border="0" bgcolor="">
										...
										<tr>
										<td>&nbsp;</td>
     <td><FONT SIZE=1  FACE="Arial" color="#000066"><?php echo 'Urgency : '; ?></td>
     <td><FONT SIZE=1  FACE="Arial" color="#000066">
	 		<input type="radio" name="urgency" value="0" <?php if($urgency==0) echo 'checked'; ?>><?php echo 'Normal'; ?>	
			<input type="radio" name="urgency" value="3" <?php if($urgency==3) echo 'checked'; ?>><?php echo 'Priority'; ?>
	 		<input type="radio" name="urgency" value="5" <?php if($urgency==5) echo 'checked'; ?>><?php echo 'Urgent'; ?>	
			<input type="radio" name="urgency" value="7" <?php if($urgency==7) echo 'checked'; ?>><?php echo 'Emergency'; ?>
     </td>
										<td width=10%>&nbsp;</td>
										<td align="left" border="1">
										
								</td><td width=20% align="left" border="1">
										<font size=1 color="purple"
								face="verdana,arial"><?php echo $LDBatchNumber ?></font><font
								color="#000000" size=2> <?php echo $batch_nr ?>
										</td>
										<td width="25%" align="right" border="1">
										<?php $user = $_SESSION['sess_user_name']?></font>
							<font size=1 color="purple"
							    face="verdana,arial"><?php echo $LDDoctorRequest ?></font><font
