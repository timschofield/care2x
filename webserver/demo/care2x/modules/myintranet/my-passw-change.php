...
<span style="color:darkred; font: bold 18px Tahoma,Arial;">
	<?PHP if (($_SESSION['sess_login_expired']>0)&&($_SESSION['sess_login_expired']!='')) print 'Password Expired,<br />Please provide the new one'?>
</span>
<p>
