...
?>
<DIV align="center">
	<h1><?php echo $LDMinorProcReport; ?><?php echo date('F Y',$start);?></h1>
...
function printOut()
    {
    	urlholder="./minor_procedures_report.php?printout=TRUE&start=<?php echo $start;?>&end=<?php echo $end;?>" ;
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
          <td width="202" bgcolor="#99ccff" > &nbsp;&nbsp;<font color="#330066"><?php echo $LDMinorProcReport; ?></font></td>
