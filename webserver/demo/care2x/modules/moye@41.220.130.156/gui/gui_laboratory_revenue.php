...
<title>'.$LDLaboratoryReport.'</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>';
echo '<html><body>';
echo '<table width="500" border="1" cellspacing="0" cellpadding="0" align="center" ';
$rep_obj->DisplayLaboratoryTableHead($admission);
$rep_obj->DisplayLaboratoryResultRows($start_timeframe, $end_timeframe, $admission);
echo '</table>';
echo '</html></body>';
exit();
}
...
function gethelp(x,s,x1,x2,x3,x4)
{
    ...
    {
    	urlholder="./laboratory_revenue.php?printout=TRUE&start_timeframe="+start_timeframe+"&end_timeframe="+end_timeframe;
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo $LDLaboratoryReport; ?></font></td>
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<form name="form1" method="post" action="">				
                          ...
                          <?php $rep_obj->DisplayLaboratoryTableHead($admission);?>

	<?php $rep_obj->DisplayLaboratoryResultRows($start_timeframe,$end_timeframe,$admission);?>
