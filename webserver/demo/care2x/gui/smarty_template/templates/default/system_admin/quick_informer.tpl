...
<tr>
	<td class="adm_item" align="right"><FONT  color="#0000cc"><b>{{$LDName}}</b> </FONT></td>
	<td class="adm_input"><input type="text" name="main_info_name" size=40 maxlength=100 value="{{$main_info_name}}">

      </td>
	</tr>
<tr>
	<td class="adm_item" align="right"><FONT  color="#0000cc"><b>{{$LDLogo}}</b> </FONT></td>
	<td class="adm_input"><input type="text" name="main_info_logo" size=40 maxlength=100 value="{{$main_info_logo}}">
