...
-- 
-- Host: localhost
-- Generation Time: Oct 03, 2008 at 10:20 AM
...
-- 
-- Table structure for table `care_tz_eye_history5`
-- 
...
CREATE TABLE `care_tz_eye_history5` (
  ...
  `hid6e` varchar(100) collate latin1_general_ci NOT NULL default '',
  `hid6d` varchar(100) collate latin1_general_ci NOT NULL default '',
  `hid7` varchar(100) collate latin1_general_ci NOT NULL,
  `hid7e` varchar(100) collate latin1_general_ci NOT NULL default '',
  `hid7d` varchar(100) collate latin1_general_ci NOT NULL default '',
...
-- 
-- Dumping data for table `care_tz_eye_history5`
-- 
