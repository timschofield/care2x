...
$LDRefDoctor = 'Ref Doctor';
$LDNextOfKin = 'Next Of Kin';
$LDNextOfKinTel = 'Next Of Kin Tel';
...
$LDServices = 'Medical Services';
$LDServicesType = '-- Select Medical Service --';
$LDServicesList= array('Unknown','Medicine','OB/GYN','Pediatrics','General Surgery','Othorpedic Surgery','Spina Bifida & HC Surgery', 'Mental Health');

$LDLabReports= 'Laboratory Reports';
$LDRadioReports= 'Radiology Reports';
$LDAdmissionHistory = 'Admission History';

$LDProcessAdvance = 'Process Advance';
$LDEnterAdvance = 'Enter Advance';
$LDEnterNotes = 'Enter Notes';
$LDAdvanceTotal='Advance Total';
