...
?>
	...
	<tr bgcolor="white">
                <td background="<?php echo createBgSkin($root_path,'tableHeaderbg3.gif'); ?>">&nbsp;<?php echo $LDDepartment ?>:
        </td>
                <td colspan=2 bgcolor="#eeeeee">
                        <select name="dept_nr">
...
?>
	...
	<tr>
        <td background="<?php echo createBgSkin($root_path,'tableHeaderbg3.gif'); ?>">&nbsp;<?php echo $LDDischargeType ?>:

        </td>

       	<td class="discharge_input">
