...
function open_drug_services() {
	urlholder="<?php echo $root_path;?>modules/pharmacy_tz/pharmacy_tz_pending_prescriptions.php<?php echo URL_APPEND;  ?>&target=search&prescrServ=serv&task=newprescription&back_path=billing";
...
<?php $bill_obj->Display_Headline($LDBilling,'','','billing_overview.php','Billing :: Main Menu'); ?>
			...
			<TR>
		       ...
		       <TR>
                        <td height="26" align=center><img src="../../gui/img/common/default/bestell.gif" border=0 width="16" height="16"></td>
                        <TD class="submenu_item"><nobr><a href="billing_tz_archive_date.php?page=1"><?php echo $LDBillingArchiveReport ?></a></nobr></TD>
