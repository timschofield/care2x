...
<title>IPD Admission Summary</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>';
echo '<html><body>';
?>
<DIV align="center">
	<h1><?php echo 'IPD Admission Summary'; ?><?php echo date('F Y',$start);?></h1>
	<p><?php echo $LDCreationTime; ?><?php echo date("F j, Y, g:i a");?></p>
         ...
         <table border="1" cellspacing="0" cellpadding="0" align="center" bgcolor=#ffffdd>
		  ...
		  <?php 
			...
			for ($day=$first_day_of_req_month; $day<=$last_day_of_req_month ; $day++) {
			  ...
			  $sql_patients="SELECT count( * ) AS ward_total FROM tmp_table WHERE current_ward_nr='$ward_nr' AND date_format( encounter_date, '%d/%m/%y' ) ='$current_date'"; 
       ...
       <?php
			  ...
			  $sql_admission_total="SELECT count( * ) AS admission_total FROM tmp_table WHERE current_ward_nr='$ward_nr' AND date_format( encounter_date, '%y.%m.%d' ) >='$startdate' AND date_format( encounter_date, '%y.%m.%d' ) <='$enddate'"; 
...
function gethelp(x,s,x1,x2,x3,x4)
{
	...
	function printOut()
    {
    	urlholder="./IPD_admissions.php?printout=TRUE&start=<?php echo $start;?>&end=<?php echo $end;?>" ;
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
          <td width="202" bgcolor="#99ccff" > &nbsp;&nbsp;<font color="#330066"><?php echo 'IPD Admission Summary'; ?></font></td>
...
<form name="form1" method="post" action=""></p>
		...
		<DIV align="center">
			<h2><?php echo 'IPD Admission Summary '; ?><?php echo date('F Y',$start);?></h1>
			<p><?php echo $LDCreationTime; ?><?php echo date("F j, Y, g:i a");?></p>
		</DIV>
        <table border="1" cellspacing="0" cellpadding="0" align="center" bgcolor=#ffffdd>
          <tr> 
