...
$rep_obj->DisplayPharmacyTableHead($category,$admission);
$rep_obj->DisplayPharmacyResultRows($start_timeframe, $end_timeframe, $category, $admission);
echo '</table>';
echo '</html></body>';
exit();
}
...
function gethelp(x,s,x1,x2,x3,x4)
{
    ...
    function printOut(start_timeframe, end_timeframe, category, admission)
    {
    	urlholder="./reporting_pharmacy.php?printout=TRUE&start_timeframe="+start_timeframe+"&end_timeframe="+end_timeframe+"&category="+category+"&admission="+admission;
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<form name="form1" method="post" action="">				
                          ...
                          <?php $rep_obj->DisplayPharmacyTableHead($category,$admission);?>

	<?php $rep_obj->DisplayPharmacyResultRows($start_timeframe,$end_timeframe,$category,$admission);?>

                          </table>
				</form>			  
						  <br><br><br>						  
<a href="javascript:printOut(<?php echo $start_timeframe.",".$end_timeframe.",".$category.",".$admission;?>)"><img border=0 src=<?php echo $root_path;?>/gui/img/common/default/billing_print_out.gif></a><br>
