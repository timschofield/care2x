...
function gethelp(x,s,x1,x2,x3,x4)
{
    ...
    {
    	urlholder="./billing_revenue_summary.php?printout=TRUE&start_timeframe="+start_timeframe+"&end_timeframe="+end_timeframe;
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo $LDRevenueReport; ?></font></td>
