...
$rep_obj->DisplayInsuranceCompanyBillingTableHead($company_id,$admission);
$rep_obj->DisplayInsuranceCompanyTestSummary($start_timeframe, $end_timeframe, $company_id, $admission);
$rep_obj->DisplayInsuranceCompanyResultRows($start_timeframe, $end_timeframe, $company_id, $admission);
echo '</table>';
echo '</html></body>';
exit();
}
...
function gethelp(x,s,x1,x2,x3,x4)
{
    ...
    function printOut(start_timeframe, end_timeframe, company_id, admission)
    {
    	urlholder="./insurance_company_financial.php?printout=TRUE&start_timeframe="+start_timeframe+"&end_timeframe="+end_timeframe+"&company_id="+company_id+"&admission="+admission;
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo $LDCompanyFinancialReport; ?></font></td>
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<form name="form1" method="post" action="">				
                          ...
                          <table width="95%" border="1" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffdd">
                     			...
                     			<?php $rep_obj->DisplayInsuranceCompanyBillingTableHead($company_id, $admission);?>

					<?php $rep_obj->DisplayInsuranceCompanyTestSummary($start_timeframe, $end_timeframe, $company_id, $admission);?>

					<?php $rep_obj->DisplayInsuranceCompanyResultRows($start_timeframe, $end_timeframe, $company_id, $admission);?>

                          </table>
				</form>	
<a href="javascript:printOut(<?php echo $start_timeframe.",".$end_timeframe.",".$company_id.",".$admission; ?>)"><img border=0 src=<?php echo $root_path;?>/gui/img/common/default/billing_print_out.gif></a><br>						  
						  <br><br><br>						  
