...
function gethelp(x,s,x1,x2,x3,x4)
{
    ...
    {
    	urlholder="./reporting_services.php?printout=TRUE&start_timeframe="+start_timeframe+"&end_timeframe="+end_timeframe+"&admission="+admission;
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo $LDServicesReport; ?></font></td>
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<form name="form1" method="post" action="">				
                          ...
                          <?php $rep_obj->DisplayServicesTableHead($category,$admission);?>
